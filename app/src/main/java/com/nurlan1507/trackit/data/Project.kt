...
class Project(
    var id:String, var title:String, var description:String, var image:ProjectBackGround,var members:MutableList<User>,  var startDate:Long, var endDate:Long, var admins: MutableList<String>) {
